document.addEventListener('DOMContentLoaded', function() {
  ...
  // Only initialize map-related functionality if location is not set
  if (typeof hasLocation !== 'undefined' && !hasLocation) {
    console.log("User has no location set - initializing location services");
    
    // Map container and info elements
    ...
    const submitManualLocationBtn = document.getElementById('submitManualLocation');
    if(submitManualLocationBtn) {
    ...
    const confirmPinLocationBtn = document.getElementById('confirmPinLocationBtn');
    if(confirmPinLocationBtn) {
      confirmPinLocationBtn.addEventListener('click', function() {
        const btn = this;
    ...
    console.log("User already has location set - skipping location initialization");
  }
});